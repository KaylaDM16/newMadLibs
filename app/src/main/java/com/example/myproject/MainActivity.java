...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentDisplay = new Intent(MainActivity.this, MadlibDisplayActivity.class);
        btnGenerate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String story = "A Day Just A Regular Day "
                ...
                story += "\t Your still on the phone with " + tvName + " so you tell them to get a " + tvItem.getText() + " and try to throw it at the person chasimng them... \t well that doesnt work the person says " + tvWord.getText() + " and chases " + tvName.getText() + " even faster. ";
